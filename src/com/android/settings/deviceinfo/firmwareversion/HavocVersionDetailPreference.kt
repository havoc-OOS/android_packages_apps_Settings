...
// LINT.IfChange
class HavocVersionDetailPreference :
    ...
    override fun getSummary(context: Context): CharSequence =
        SystemProperties.get(HAVOC_VERSION_PROPERTY, context.getString(R.string.unknown));
    ...
    companion object {
        ...
        const val HAVOC_VERSION_PROPERTY: String = "ro.havoc.build.version"
...
// LINT.ThenChange(HavocVersionDetailPreferenceController.java)
