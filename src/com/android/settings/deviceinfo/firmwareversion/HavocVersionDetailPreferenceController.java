...
// LINT.IfChange
public class HavocVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "havocVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_HAVOC_VERSION_PROP = "ro.havoc.build.version";
    ...
    public HavocVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(KEY_HAVOC_VERSION_PROP,
...
// LINT.ThenChange(HavocVersionDetailPreference.kt)
