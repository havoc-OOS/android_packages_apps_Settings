...
class HavocLegalPreference(override val key: String, @StringRes val defaultTitle: Int = 0) :
    PreferenceMetadata, PreferenceTitleProvider, PreferenceAvailabilityProvider {

    private companion object {
        const val PROPERTY_HAVOC_LICENSE_URL = "ro.havoclegal.url"
    }

    private fun getLicenseUrl(): String = SystemProperties.get(PROPERTY_HAVOC_LICENSE_URL)
